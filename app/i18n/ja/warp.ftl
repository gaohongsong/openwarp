...
workspace-left-panel-ssh-manager-import = ~/.ssh/config からインポート
workspace-left-panel-ssh-manager-import-title = SSH ホストをインポート
workspace-left-panel-ssh-manager-import-empty = ~/.ssh/config にホストが見つかりません
workspace-left-panel-ssh-manager-import-select-all = すべて選択
workspace-left-panel-ssh-manager-import-deselect-all = すべて解除
workspace-left-panel-ssh-manager-import-button = インポート
workspace-left-panel-ssh-manager-advanced = 詳細設定
workspace-left-panel-ssh-manager-detail-proxy-jump = プロキシジャンプ
workspace-left-panel-ssh-manager-detail-connect-timeout = 接続タイムアウト（秒）
workspace-left-panel-ssh-manager-detail-keepalive-interval = キープアライブ間隔（秒）
workspace-left-panel-ssh-manager-detail-keepalive-count = キープアライブ最大回数
workspace-left-panel-ssh-manager-detail-host-key-algorithms = ホスト鍵アルゴリズム
workspace-left-panel-ssh-manager-detail-pubkey-accepted-key-types = 公開鍵受理タイプ
