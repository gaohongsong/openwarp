...
workspace-left-panel-ssh-manager-import = 从 ~/.ssh/config 导入
workspace-left-panel-ssh-manager-import-title = 导入 SSH 主机
workspace-left-panel-ssh-manager-import-empty = 在 ~/.ssh/config 中未找到主机
workspace-left-panel-ssh-manager-import-select-all = 全选
workspace-left-panel-ssh-manager-import-deselect-all = 全不选
workspace-left-panel-ssh-manager-import-button = 导入
workspace-left-panel-ssh-manager-advanced = 高级
workspace-left-panel-ssh-manager-detail-proxy-jump = 代理跳板
workspace-left-panel-ssh-manager-detail-connect-timeout = 连接超时（秒）
workspace-left-panel-ssh-manager-detail-keepalive-interval = 保活间隔（秒）
workspace-left-panel-ssh-manager-detail-keepalive-count = 保活最大计数
workspace-left-panel-ssh-manager-detail-host-key-algorithms = 主机密钥算法
workspace-left-panel-ssh-manager-detail-pubkey-accepted-key-types = 公钥接受类型
