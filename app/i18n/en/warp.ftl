...
workspace-left-panel-ssh-manager-import = Import from ~/.ssh/config
workspace-left-panel-ssh-manager-import-title = Import SSH Hosts
workspace-left-panel-ssh-manager-import-empty = No hosts found in ~/.ssh/config
workspace-left-panel-ssh-manager-import-select-all = Select All
workspace-left-panel-ssh-manager-import-deselect-all = Deselect All
workspace-left-panel-ssh-manager-import-button = Import
workspace-left-panel-ssh-manager-advanced = Advanced
workspace-left-panel-ssh-manager-detail-proxy-jump = Proxy Jump
workspace-left-panel-ssh-manager-detail-connect-timeout = Connect Timeout (seconds)
workspace-left-panel-ssh-manager-detail-keepalive-interval = Keepalive Interval (seconds)
workspace-left-panel-ssh-manager-detail-keepalive-count = Keepalive Count Max
workspace-left-panel-ssh-manager-detail-host-key-algorithms = Host Key Algorithms
workspace-left-panel-ssh-manager-detail-pubkey-accepted-key-types = Pubkey Accepted Key Types
